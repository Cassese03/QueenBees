...
export default function TextEditor() {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      if (response.ok) {
        message.success('Contenuti salvati con successo!');
        loadContents();
      } else {
        ...
        title={
          <div>
            ...
            <p style={{ margin: '8px 0 0 0', fontSize: 14, color: '#666', fontWeight: 'normal' }}>
              Modifica tutti i contenuti testuali del sito. Ogni modifica sarà immediatamente visibile dopo il salvataggio.
            </p>
          </div>
        }
        extra={
